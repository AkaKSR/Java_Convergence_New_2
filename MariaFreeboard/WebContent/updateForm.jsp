		...
		<table>
					...
					<div class="row">
						<div class="col">
							<input type="text" class="form-control" name="subject"
								id="subject" placeholder="제목입력" required="required"
								value="${vo.subject }">
						</div>
					</div>
				</td>
					...
					<div class="row">
						<div class="col">
							<textarea class="form-control" rows="15" cols="90" name="content"
								id="content" style="margin-top: 5px;">${vo.content }</textarea>
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<input type="hidden" name="b" value="${blockSize }">
					<button type="submit" class="btn btn-success btn-sm" id="submitBtn">수정하기</button>
