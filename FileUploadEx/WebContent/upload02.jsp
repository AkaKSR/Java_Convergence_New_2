		...
		for (FileItem item : items) {
			...
			if (item.isFormField()) {
				...
				if (sizeInBytes > 0) {
					...
					out.println("<a href='download.jsp?s=" + URLEncoder.encode(saveFileName, "UTF-8") + "&o="
							+ fileName + "'>" + URLEncoder.encode(fileName, "UTF-8") + "</a><br>");
					out.println("<a href='download.jsp?s=" + saveFileName + "&o=" + fileName + "'>" + fileName
							+ "</a><br>");
				}
			}
		}
